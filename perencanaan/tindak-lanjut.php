                                ...
                                <div class="card-body ml-3 mt-2">
                                    ...
                                    <form method="post" action="">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <textarea class="form-control form-control-sm border-secondary" id="penanganan" name="penanganan" rows="5"><?=$data['penanganan']?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="catatan" class="col-sm-4 col-form-label">Catatan</label>
                                            <div class="col-sm-7">
                                                <textarea class="form-control form-control-sm border-secondary" id="catatan" name="catatan" rows="2"><?=$data['catatan']?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="tgl_tangani" class="col-sm-4 col-form-label">Tanggal Penanganan</label>
                                            <div class="col-sm-7">
                                                <input type="date" class="form-control form-control-sm border-secondary" id="tgl_tangani" name="tgl_tangani" value="<?=$data['tgl_tangani']?>">
                                            </div>
                                        </div>
