...
<body id="beranda">
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg navbar-dark shadow fixed-top" style="background-color: rgba(55, 55, 55, 0.7)">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="otheruser/registrasi.php">Registrasi</a>
                    </li>
                    <li class="nav-item">
    ...
    <section class="jumbotron text-left">
        <div class="#">
            <div class="text-land ps-5 pe-5">
                <h1 class="display-2 mt-3 mb-3">Selamat Datang di Compact Service PDAM Balangan</h1>
                <p class="lead">Website pelayanan online PDAM Balangan yang dapat memudahkan anda</br>mengakses layanan kami secara online dari mana saja dan kapan saja</p>
                <p class="lead1">Ingin mengajukan pemasangan sambungan baru? <a href="otheruser/registrasi.php">Registrasi di sini</a></p>
                <p class="lead1">Sudah registrasi dan melakukan pembayaran biaya pendaftaran? <a href="otheruser/upload-bayar.php">Upload bukti bayar di sini</a></p>
            </div>
        </div> 
        <svg id="svg-jumbotron" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#ffffff" fill-opacity="1" d="M0,128L120,128C240,128,480,128,720,112C960,96,1200,64,1320,48L1440,32L1440,320L1320,320C1200,320,960,320,720,320C480,320,240,320,120,320L0,320Z"></path></svg>
    </section>
